...
conditions = [((.45*dfData990_2017['gross_rev'])<=10000000),((.45*dfData990_2017['gross_rev'])>10000000)]
choices = [(.45*dfData990_2017['gross_rev']),(10000000)]
dfData990_2017['45_of_Gross_max_10m'] = np.select(conditions,choices) 

conditions = [((.45*dfData990_2017['earned_program_service_rev'])<=10000000),((.45*dfData990_2017['earned_program_service_rev'])>10000000)]
choices = [(.45*dfData990_2017['earned_program_service_rev']),(10000000)]
dfData990_2017['45_of_Earned_max_10m'] = np.select(conditions,choices)

conditions = [((dfData990_2017['earned_program_service_rev'])<=(dfData990_2017['45_of_Gross_max_10m'])),((dfData990_2017['earned_program_service_rev'])>(dfData990_2017['45_of_Gross_max_10m']))]
choices = [(dfData990_2017['earned_program_service_rev']),(dfData990_2017['45_of_Gross_max_10m'])]
dfData990_2017['100_of_Earned_upto_45_Gross_max_10m'] = np.select(conditions,choices)
...
conditions = [((.45*dfData990ez_2017['gross_rev'])<=10000000),((.45*dfData990ez_2017['gross_rev'])>10000000)]
choices = [(.45*dfData990ez_2017['gross_rev']),(10000000)]
dfData990ez_2017['45_of_Gross_max_10m'] = np.select(conditions,choices) 

conditions = [((.45*dfData990ez_2017['earned_program_service_rev'])<=10000000),((.45*dfData990ez_2017['earned_program_service_rev'])>10000000)]
choices = [(.45*dfData990ez_2017['earned_program_service_rev']),(10000000)]
dfData990ez_2017['45_of_Earned_max_10m'] = np.select(conditions,choices)

conditions = [((dfData990ez_2017['earned_program_service_rev'])<=(dfData990ez_2017['45_of_Gross_max_10m'])),((dfData990ez_2017['earned_program_service_rev'])>(dfData990ez_2017['45_of_Gross_max_10m']))]
choices = [(dfData990ez_2017['earned_program_service_rev']),(dfData990ez_2017['45_of_Gross_max_10m'])]
dfData990ez_2017['100_of_Earned_upto_45_Gross_max_10m'] = np.select(conditions,choices)
...
conditions = [((.45*dfData990_2018['gross_rev'])<=10000000),((.45*dfData990_2018['gross_rev'])>10000000)]
choices = [(.45*dfData990_2018['gross_rev']),(10000000)]
dfData990_2018['45_of_Gross_max_10m'] = np.select(conditions,choices) 

conditions = [((.45*dfData990_2018['earned_program_service_rev'])<=10000000),((.45*dfData990_2018['earned_program_service_rev'])>10000000)]
choices = [(.45*dfData990_2018['earned_program_service_rev']),(10000000)]
dfData990_2018['45_of_Earned_max_10m'] = np.select(conditions,choices)

conditions = [((dfData990_2018['earned_program_service_rev'])<=(dfData990_2018['45_of_Gross_max_10m'])),((dfData990_2018['earned_program_service_rev'])>(dfData990_2018['45_of_Gross_max_10m']))]
choices = [(dfData990_2018['earned_program_service_rev']),(dfData990_2018['45_of_Gross_max_10m'])]
dfData990_2018['100_of_Earned_upto_45_Gross_max_10m'] = np.select(conditions,choices)
...
conditions = [((.45*dfData990ez_2018['gross_rev'])<=10000000),((.45*dfData990ez_2018['gross_rev'])>10000000)]
choices = [(.45*dfData990ez_2018['gross_rev']),(10000000)]
dfData990ez_2018['45_of_Gross_max_10m'] = np.select(conditions,choices) 

conditions = [((.45*dfData990ez_2018['earned_program_service_rev'])<=10000000),((.45*dfData990ez_2018['earned_program_service_rev'])>10000000)]
choices = [(.45*dfData990ez_2018['earned_program_service_rev']),(10000000)]
dfData990ez_2018['45_of_Earned_max_10m'] = np.select(conditions,choices)

conditions = [((dfData990ez_2018['earned_program_service_rev'])<=(dfData990ez_2018['45_of_Gross_max_10m'])),((dfData990ez_2018['earned_program_service_rev'])>(dfData990ez_2018['45_of_Gross_max_10m']))]
choices = [(dfData990ez_2018['earned_program_service_rev']),(dfData990ez_2018['45_of_Gross_max_10m'])]
dfData990ez_2018['100_of_Earned_upto_45_Gross_max_10m'] = np.select(conditions,choices)
...
conditions = [((.45*dfData990_2019['gross_rev'])<=10000000),((.45*dfData990_2019['gross_rev'])>10000000)]
choices = [(.45*dfData990_2019['gross_rev']),(10000000)]
dfData990_2019['45_of_Gross_max_10m'] = np.select(conditions,choices) 

conditions = [((.45*dfData990_2019['earned_program_service_rev'])<=10000000),((.45*dfData990_2019['earned_program_service_rev'])>10000000)]
choices = [(.45*dfData990_2019['earned_program_service_rev']),(10000000)]
dfData990_2019['45_of_Earned_max_10m'] = np.select(conditions,choices)

conditions = [((dfData990_2019['earned_program_service_rev'])<=(dfData990_2019['45_of_Gross_max_10m'])),((dfData990_2019['earned_program_service_rev'])>(dfData990_2019['45_of_Gross_max_10m']))]
choices = [(dfData990_2019['earned_program_service_rev']),(dfData990_2019['45_of_Gross_max_10m'])]
dfData990_2019['100_of_Earned_upto_45_Gross_max_10m'] = np.select(conditions,choices)
...
conditions = [((.45*dfData990ez_2019['gross_rev'])<=10000000),((.45*dfData990ez_2019['gross_rev'])>10000000)]
choices = [(.45*dfData990ez_2019['gross_rev']),(10000000)]
dfData990ez_2019['45_of_Gross_max_10m'] = np.select(conditions,choices) 

conditions = [((.45*dfData990ez_2019['earned_program_service_rev'])<=10000000),((.45*dfData990ez_2019['earned_program_service_rev'])>10000000)]
choices = [(.45*dfData990ez_2019['earned_program_service_rev']),(10000000)]
dfData990ez_2019['45_of_Earned_max_10m'] = np.select(conditions,choices)

conditions = [((dfData990ez_2019['earned_program_service_rev'])<=(dfData990ez_2019['45_of_Gross_max_10m'])),((dfData990ez_2019['earned_program_service_rev'])>(dfData990ez_2019['45_of_Gross_max_10m']))]
choices = [(dfData990ez_2019['earned_program_service_rev']),(dfData990ez_2019['45_of_Gross_max_10m'])]
dfData990ez_2019['100_of_Earned_upto_45_Gross_max_10m'] = np.select(conditions,choices)
...
df = df[(df['NAICS'].str.startswith('71211')) | (df['NAICS'].str.startswith('71212')) | (df['NAICS'].str.startswith('71213')) | (df['NTEEFINAL'].str.startswith('A50')) | (df['NTEEFINAL'].str.startswith('A51')) | (df['NTEEFINAL'].str.startswith('A52')) | (df['NTEEFINAL'].str.startswith('A54')) | (df['NTEEFINAL'].str.startswith('A56')) | (df['NTEEFINAL'].str.startswith('A57')) | (df['NTEEFINAL'].str.startswith('A80')) | (df['NTEEFINAL'].str.startswith('A82')) | (df['NTEEFINAL'].str.startswith('D50'))]
df = df[df['OUTNCCS']=='IN']
...
saveName = "CleanedPerformingArtsData_SaveOurStages_Museums-History-Orgs.csv"
...
columnsToCalculate = ['contributed_rev','earned_program_service_rev','total_rev','total_exp','gross_rev','45_of_Gross_max_10m','45_of_Earned_max_10m','100_of_Earned_upto_45_Gross_max_10m']
...
# Convert dataframe to CSV and save
saveName = "SummaryStats_SaveOurStages_10Mcap_Museums-History-Orgs.csv"
